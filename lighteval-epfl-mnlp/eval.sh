...
MODEL_CONFIGS=(
     ...
     # "model_configs/MNLP_M2_mcqa_model_bis.yaml"
     # "model_configs/MNLP_M2_mcqa_model_e3.yaml"
     ...
     # "model_configs/MNLP_M2_mcqa_model_cot00_e2.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot00_e3.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot05_e3.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot10_e3.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot10_e3_b32.yaml"
     # "model_configs/MNLP_M2_mcqa_model_arnault.yaml"
     # "model_configs/MNLP_M2_mcqa_model_arnault_rag.yaml"
     # "model_configs/MNLP_M3_mcqa_model_arnault_rag_best.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot00_legacy_prompt.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot00_legacy_prompt_e3.yaml"
     # "model_configs/MNLP_M2_mcqa_model_cot00_legacy_prompt_trunc.yaml"
     # "model_configs/MNLP_M3_mcqa_model_cot00_e1.yaml"
     # "model_configs/MNLP_M3_mcqa_model_cot00_e2.yaml"
     # "model_configs/MNLP_M3_mcqa_model_cot00_e3.yaml"
